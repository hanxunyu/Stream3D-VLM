...
from .feature_fusion import FeatureFusionModule, FeatureFusionConfig, GeometryFeatureMerger, Concat_GeometryFeatureMerger
...
class Qwen2_5_VLForConditionalGenerationWithVGGT(Qwen2_5_VLPreTrainedModel, GenerationMixin):
    ...
    def _init_geometry_encoder(self, config):
        ...
        encoder_config = GeometryEncoderConfig(
            encoder_type=getattr(config, "geometry_encoder_type", "streamvggt"),
        ...
        self.geometry_encoder = create_geometry_encoder(
            ...
            train_or_eval_mode=encoder_config.train_or_eval_mode
        )
        ...
        # Create Concat feature merger
        self.concat_geometry_merger = Concat_GeometryFeatureMerger(
            output_dim=config.hidden_size,
            hidden_dim=getattr(config, "geometry_merger_hidden_dim", 4096),
            context_dim=self.geometry_encoder.get_feature_dim(),
            spatial_merge_size=config.vision_config.spatial_merge_size,
        ...
        fusion_config = FeatureFusionConfig(
            ...
            num_layers=getattr(config, "fusion_num_layers", 3)
        )
        ...
        **kwargs,
        ...
        if labels is not None:
            ...
            if vision_end_token_id is not None and frame_interval_token_id is not None and frame_end_token_id is not None:
                ...
                for pos in vision_end_positions:
                    pos_item = pos.item()
