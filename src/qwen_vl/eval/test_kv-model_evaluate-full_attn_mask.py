...
# 修改：在query后续帧输入的时候，同时传入new_image_attention_mask，使得新图像的tokens可以互相注意到、使用kv cache使得可以关注到history信息
...
def main():
    ...
    parser.add_argument("--data_path", type=str, default="/apdcephfs_cq11/share_1603164/user/jonnyhxyu/dataset/our_dataset_subset-v2/stream3d-bench/online_format/online-S3D_Benchmark_10k_only_scannet.json")
    parser.add_argument("--image_root", type=str, default="/apdcephfs_sh2/share_300000800/data/multimodal/hanxun_data/OpenDataLab___ScanNet_v2/raw/our-posed_images")
    parser.add_argument("--output_path", type=str, default="/apdcephfs_cq11/share_1603164/user/jonnyhxyu/Stream3D-LLM/new-logs/ours_evaluation-results/cache_v4-streaming_optimized_results.json")
